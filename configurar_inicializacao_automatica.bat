@echo off
title Configurar Auto-Start do Noozy no Windows
echo ========================================================
echo   CONFIGURANDO INICIALIZACAO AUTOMATICA DO NOOZY
echo ========================================================
echo.

set SCRIPT_PATH=%~dp0iniciar_segundo_plano.vbs
set STARTUP_FOLDER=%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup
set SHORTCUT_PATH=%STARTUP_FOLDER%\NoozyBot.lnk
...
if exist "%SHORTCUT_PATH%" (
    echo [SUCESSO] O Bot Noozy agora vai ligar automaticamente sempre que voce ligar o computador!
    echo.
